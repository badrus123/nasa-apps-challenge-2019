        ...
        <aside class="menu-sidebar d-none d-lg-block">
            <div class="logo">
                <a href="#" style="color:black; font-size:24px">
                    <img width="20%" src="<?= base_url().'asset/images/icon/logo.png'?>" alt="Cool Admin" />
                    Si Helti
                </a>
            </div>
            <div class="menu-sidebar__content js-scrollbar1">
                <nav class="navbar-sidebar">
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li>
                            <a href="<?= site_url("Table/index") ?>">
                            <i class="fas fa-table"></i>Tables</a>
                        </li>
                        <li>
                            <a href="<?= site_url("Form/index") ?>">
                            <i class="far fa-check-square"></i>Forms</a>
                        </li>
                                    ...
                                    <div class="account-item clearfix js-item-menu">
                                        ...
                                        <div class="account-dropdown js-dropdown">
                                            <div class="info clearfix">
                                                <div class="image">
                                                    <a href="#">
                                                        <img src="<?= base_url().'asset/images/icon/avatar-01.jpg'?>" alt="<?= $this->session->userdata('nama') ?>" />
                                                    </a>
                                                </div>
                                                <div class="content">
                                                    <h5 class="name">
